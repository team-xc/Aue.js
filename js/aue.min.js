...
static loadEl(el){function loadDiv(el){var child=el.firstChild;while(child!=el.lastChild){if(child.nodeType==1){if(child.innerText.match(/{{(.+)}}/g)!==null)
...
Aue.setClick(child);if(child.tagName==='DIV')
loadDiv(child);}
